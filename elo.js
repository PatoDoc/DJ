...
// Filter gamesData for "Schotten Totten" matches
const schottenTottenGames = gamesData.filter(game => game.jogo === "Schotten Totten");
console.log('Number of Schotten Totten games:', schottenTottenGames.length);

// Process each game for ELO ratings
schottenTottenGames.forEach(game => {
